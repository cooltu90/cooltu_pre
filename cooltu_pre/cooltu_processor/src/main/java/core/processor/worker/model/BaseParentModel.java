        ...
        Ts.ls(vis, new Each<LayoutTools.ViewInfo>() {
            ...
            public boolean each(int position, LayoutTools.ViewInfo vi) {
                ...
                addLnTag(findViewSb, "        [n1] = [n2]findViewById([n3].R.id.[n4]);",
                        ...
                        isCoreR ? Pkg.CORE_LIB4A : layoutId.rPackage,
                        vi.id);
                return false;
            }
        });
                ...
                TypeLss.ls(ps, new EachType() {
                    ...
                    public void each(int position, String type, String name) {
                        ...
                        if (FullName.VIEW.equals(type)) {
                            ...
                            try {
                                addTag(pSb, "([type]) view.getTag(core.lib4a.R.id.tag_[n])", type, nums[0]);
                            } catch (Exception e) {
                                Logs.i(e);
                            }
                            nums[0]++;
                ...
                TypeLss.ls(ps, new EachType() {
                    ...
                    public void each(int position, String type, String name) {
                        ...
                        if (FullName.VIEW.equals(type)) {
                            ...
                            try {
                                addTag(sb, "([type]) view.getTag(core.lib4a.R.id.tag_[n])", type, nums[0]);
                            } catch (Exception e) {
                                Logs.i(e);
                            }
                            nums[0]++;
