...
public interface FragmentBaseModelInterface {
    ...
    default List<String> getTempLinesArray() {
        ...
        lines.add("");
        lines.add("import core.lib4a.act.OnActBack;");
        lines.add("import core.lib4a.net.bean.CoreSendParams;");
        lines.add("import core.lib4a.net.netback.NetBackI;");
        ...
        lines.add("[[binds]]");
        lines.add("[[resources]]");
        lines.add("        ((core.lib4a.act.CoreActivity) getActivity()).addOnActBack(this);");
