...
public interface NetModelInterface {
    ...
    default List<String> getTempLinesArray() {
        ...
        lines.add("");
        lines.add("import com.codingtu.cooltu.lib4a.net.NetTool;");
        lines.add("import com.codingtu.cooltu.lib4a.net.api.API;");
        lines.add("import com.codingtu.cooltu.lib4a.net.api.CreateApi;");
