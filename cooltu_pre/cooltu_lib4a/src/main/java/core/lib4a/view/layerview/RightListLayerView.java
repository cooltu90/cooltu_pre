package core.lib4a.view.layerview;
...
import core.lib4a.view.layerview.listener.LayerListener;
...
public class RightListLayerView extends LayerView {
    ...
    public RightListLayerView(Context context) {
        super(context);
    }

    public RightListLayerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RightListLayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public RightListLayerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
