...
import com.codingtu.cooltu.lib4j.os.each.Each;
import com.codingtu.cooltu.lib4j.os.each.MapEach;
import com.codingtu.cooltu.lib4j.os.finalgetter.FinalGetter;
import com.codingtu.cooltu.lib4j.os.getter.Getter;
import com.codingtu.cooltu.lib4j.os.getter.SameGetter;
import com.codingtu.cooltu.lib4j.tools.CountTool;
import com.codingtu.cooltu.lib4j.tools.OtherTool;
import com.codingtu.cooltu.lib4j.os.eachgetter.EachGetter;
...
public class Ls {
    ...
    private static <T> void groupSort(List<T> container, int levels, int level, ListValueMap<String, String> categorgMap, Map<String, T> tMap, String key) {
        Ls.ls(categorgMap.get(key), new Each<String>() {
            @Override
